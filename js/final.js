...
function formularioPropinas() {
    ...
    checkBox0.name = 'propina';
    checkBox0.value = "0";
    checkBox0.classList.add('form-check-input');
    checkBox0.onclick = calcularPropina;

    const checkLabel0 = document.createElement('LABEL');
    checkLabel0.textContent = 'Sin propina';
    ...
    formulario.appendChild(checkDiv0);
